...
public class DateUtil {
	...
	public static String strToStrShort(String date){
		return dateToStr(strToDateLong(date));
	}
	...
	public static String getTwoDay(String sj1, String sj2) {
		FastDateFormat myFormatter = FastDateFormat
				.getInstance("yyyy-MM-dd");
		long day = 0;
		try {
	...
	public static boolean isSameWeekDates(long date1,long date2){
		...
		return isSameWeekDates(cal1,cal2);
	}
	 ...
	 * @return
	 */
	private static boolean isSameWeekDates(Calendar cal1,Calendar cal2){
	...
	/**
	 * 获取两个日期的区间，即相距多少天 字符串的日期格式的计算
	 * 
	 * @param dateEnd
	 * @return
	 */
	public static int daysBetween(long dateStart, long dateEnd){
		long between_days = (dateEnd - dateStart) / (1000 * 3600 * 24);
	...
	public static String getWeek(String sdate, String num) {
		...
		return FastDateFormat.getInstance("yyyy-MM-dd").format(c.getTime());
	}
	...
	public static String getWeek(String sdate) {
		...
		// 1=星期日 7=星期六，其他类推
		return FastDateFormat.getInstance("EEEE").format(c.getTime());
	}

	...
	Handler handler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				asyncNetworkManager.recomand4G(RecomandLLyAty.this, userPhone, intentPhone, new AsyncNetworkManager.IRecomand4G() {
					@Override
...
//							}
	...
	public void shareOnClick(View v) {
		if (!"".equals( edtShareContent.getText().toString())&&!"".equals(edtPhone.getText().toString())) {
			...
			JUtil.showMsg(RecomandLLyAty.this, "短信内容不能为空！");
		}else if("".equals( edtPhone.getText().toString())){
			JUtil.showMsg(RecomandLLyAty.this, "电话不能为空！");
		}
		
	}
	public void choiceContractOnClick(View v) {
		Intent intent = new Intent(RecomandLLyAty.this,SingleActivity.class);
...
//									+ "】");
	...
	private void sendSMS(String toAddress, String body, Long id) {
		...
		RecomandLLyAty.this, 0, sentIntent, PendingIntent.FLAG_UPDATE_CURRENT);
